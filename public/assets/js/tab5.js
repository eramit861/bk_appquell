// Tab5 & Tab7 Expenses Questionnaire JavaScript
// This file contains all JavaScript functionality for both Tab5 (Current Household Expenses) 
// and Tab7 (Spouse Expenses) questionnaires
...
// Remove relationship form function
...
function updateAveragePrice(no = '') {
...
function formatNumberToPrice(data) {
    return data.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
}

// Sum expenses calculation
function sumexpesnes() {
    var expensesum = 0;
...
window.removeRelationshipForm = removeRelationshipForm;
window.updateAveragePrice = updateAveragePrice;
window.formatNumberToPrice = formatNumberToPrice;
window.sumexpesnes = sumexpesnes;
