...
// Registration Routes...
Route::get('register/{package_id}', [RegisterController::class,'showRegistrationForm'])->name('register');
Route::post('register/{package_id}', [RegisterController::class,'register']);
