@php
$array = [
        "paycheck_mandatory_contribution" => "Mandatory Retirement (Pension)",
        "paycheck_voluntary_contribution" => "Voluntary Retirement (401K, IRA)",
        "paycheck_required_repayment" => "Repayment of Loan (Retirement loan or employer loan)",
        "automatically_deduction_insurance" => "Deducted for insurance (Health, vision, dental, etc)",
        "domestic_support_obligations" => "Domestic Support Obligations (Child support, alimony)",
        "union_dues_deducted" => "Union dues",
