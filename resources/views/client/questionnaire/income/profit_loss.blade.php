@php
    ...
    $onChangeRoute = route('client_profit_loss_popup');
    $saveRoute = route('client_profit_loss_setup');
@endphp
<div class="modal-dialog m-0 profit-loss-popup">
                ...
                <form name="proftloss_form" action="" method="post" novalidate>
                    ...
                    <div class="profitlosspopup  profitpopup">
                        <div class="row no-border-elements">
                            @for ($i = 1; $i <= 1; $i++)
                                @csrf
                                <x-questionnaire.income.profitLossPopup.profitlossPopupContent :incomeProfitLoss="$income_profit_loss"
                                    ...
                                    :web_view="$web_view" :majorLawProfitLossLabels="$majorLawProfitLossLabels" :basicInfoPartA="$BasicInfoPartA" :basicInfoPartB="$BasicInfo_PartB"
                                    :final_date="$final_date" :attProfitLossMonths="$attProfitLossMonths"
