<div class="col-12">
    <div class="light-gray-div">
        ...
        @if (Helper::validate_key_value('spouse_different_address', $spouse_different_address))
            <div class="row gx-3">
                <div class="col-12">
                    <div class="label-div question-area">
                        <label>
        ...
        <div class="row gx-3">
            <div class="col-12">
                <div class="label-div question-area">
                    ...
                    <div class="custom-radio-group form-group">
                        <input type="radio" name="PaymentsforadditionaldepSpouse"
                            id="PaymentsforadditionaldepSpouse_yes" class="d-none required" value="1"
                            {{ Helper::validate_key_toggle('PaymentsforadditionaldepSpouse', $expenses, 1) }}>
                        <label for="PaymentsforadditionaldepSpouse_yes"
                            class="btn-toggle {{ Helper::validate_key_toggle_active('PaymentsforadditionaldepSpouse', $expenses, 1) }}"
                            onclick="getPaymentsforadditionaldepSpouse('yes');">Yes</label>

                        <input type="radio" name="PaymentsforadditionaldepSpouse"
                            id="PaymentsforadditionaldepSpouse_no" class="d-none required" value="0"
                            {{ Helper::validate_key_toggle('PaymentsforadditionaldepSpouse', $expenses, 0) }}>
                        <label for="PaymentsforadditionaldepSpouse_no"
                            class="btn-toggle {{ Helper::validate_key_toggle_active('PaymentsforadditionaldepSpouse', $expenses, 0) }}"
                            onclick="getPaymentsforadditionaldepSpouse('no');">No</label>
                    </div>
                </div>
            </div>
            <div class="col-12 other_insurance {{ Helper::key_hide_show_v('PaymentsforadditionaldepSpouse', $expenses) }}"
                id="PaymentsforadditionaldepSpouse_data">
                <div class="row">
