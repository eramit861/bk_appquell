<div class="col-12">
    <div class="light-gray-div mt-2">
        ...
        <div class="row gx-3">
                ...
                <div class="label-div question-area">
                    ...
                    <div class="custom-radio-group form-group">
                        <input type="radio" name="increase_decrease_expenses_option"
                            id="increase_decrease_expenses_option_yes" class="d-none required" value="1" {{ Helper::validate_key_toggle('increase_decrease_expenses_option', $expenses, 1) }}>
                        <label for="increase_decrease_expenses_option_yes"
                        ...
                        <input type="radio" name="increase_decrease_expenses_option"
                            id="increase_decrease_expenses_option_no" class="d-none required" value="0" {{ Helper::validate_key_toggle('increase_decrease_expenses_option', $expenses, 0) }}>
                        <label for="increase_decrease_expenses_option_no"
            ...
            <div class="col-12 {{ Helper::key_hide_show_v('increase_decrease_expenses_option', $expenses) }}"
                id="div_desc_incexp">
                <div class="label-div">
                    <div class="form-group">
                        <label for="">Specify</label>
                        <textarea id="increase_decrease_expenses" name="increase_decrease_expenses"
                            class="input_capitalize form-control required h-unset" cols="30" rows="3"
                            placeholder="Description">{{ Helper::validate_key_value('increase_decrease_expenses', $expenses) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
