            ...
            <div class="col-12">
                <div class="label-div question-area">
                    ...
                    <div class="custom-radio-group form-group">
                        <input type="radio" name="otherInsNotListedSpouse" id="otherInsNotListedSpouse_yes"
                            class="d-none required" value="1"
                            {{ Helper::validate_key_toggle('otherInsNotListedSpouse', $expenses, 1) }}>
                        <label for="otherInsNotListedSpouse_yes"
                            class="btn-toggle {{ Helper::validate_key_toggle_active('otherInsNotListedSpouse', $expenses, 1) }}"
                            onclick="getotherInsNotListedSpouse('yes');">Yes</label>

                        <input type="radio" name="otherInsNotListedSpouse" id="otherInsNotListedSpouse_no"
                            class="d-none required" value="0"
                            {{ Helper::validate_key_toggle('otherInsNotListedSpouse', $expenses, 0) }}>
                        <label for="otherInsNotListedSpouse_no"
                            class="btn-toggle {{ Helper::validate_key_toggle_active('otherInsNotListedSpouse', $expenses, 0) }}"
                            onclick="getotherInsNotListedSpouse('no');">No</label>
                    </div>
                </div>
            </div>
            <div class="col-12 other_insurance {{ Helper::key_hide_show('otherInsNotListedSpouse', $expenses) }}"
                id="other_insurance1">
                <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ Helper::current(Helper::validate_key_value('other_insurance_price', $expenses, 'float')) }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="label-div">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control price-field expense_prices required"
                                        name="other_expense_value"
                                        value="{{ Helper::validate_key_value('other_expense_value', $expenses, 'float') }}" />
                                </div>
                            </div>
                        </div>
                    </div>
