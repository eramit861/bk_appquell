<div class="outline-gray-border-area">
    @if (!empty($finacial_affairs['list_financial_institutions_data']['name']) && is_array($finacial_affairs['list_financial_institutions_data']['name']))
        ...
        @endfor
    @else
        @include("client.questionnaire.affairs.list_financial_institutions", ['i' => 0, 'isEmpty'=>true])
    @endif
    <div class="add-more-div-bottom">
        <button type="button" id="add-more-residence-form" class="btn-new-ui-default py-1 px-2" onclick="addListFinancialInstitutionsForm(); return false;">
            <i class="bi bi-plus-lg"></i>
            Add Additional Financial Institutions
        </button>
    </div>
</div>