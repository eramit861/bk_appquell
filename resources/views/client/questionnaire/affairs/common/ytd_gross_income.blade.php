<div class="row gx-3">
        ...
        <div class="border-bottom-default mb-3">
            <div class="row">
                <div class="col-xl-6 col-lg-7 col-md-12 col-12">
                    <label class="fs-16px"><span class="text-c-blue"><strong>YTD:</strong></span> Year to date gross
                        income <span class="text-c-blue">(get this from your last pay check stub)</span></label>
                </div>
                <div class="col-xl-6 col-lg-5 col-md-12 col-12">
                    @if (env('APP_ENV') == 'local' || env('APP_ENV') == 'development')
                        <div class="video-div float_right d-flex align-items-center me-0">
                            <a href="javascript:void(0)" class="btn-new-ui-default py-2 px-3 mb-1">Get IRS
                                Transcripts</a>
                        </div>
                    @endif
                    <div class="video-div float_right d-flex align-items-center">
                        <button type="button" class="video-btn" data-bs-toggle="modal" data-bs-target="#video_modal"
                            onclick="run_tutorial_videos(this,'#video_modal')" data-video="{{ $video1['en'] }}"
                            data-video2="{{ $video1['sp'] }}">
                    ...
                    <div class="video-div d-flex float_right align-items-center">
                        <button type="button" class="video-btn py-1"
                            onclick="showTaxPayingPopup('{{ route('tax_paying_popup') }}');">
                            <div>Need help getting a tax return?</div>
    ...
    <div class="col-xl-{{ $client_type == 3 ? '6' : '12' }} col-12">
        @include('client.questionnaire.affairs.common.total_amount_income_table')
    </div>
    @if ($client_type == 3)
        <div class="col-xl-6 col-12">
            @include('client.questionnaire.affairs.common.total_amount_income_spouse')
        </div>
    @endif
