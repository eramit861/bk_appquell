<div class="outline-gray-border-area">
    @if(!empty($finacial_affairs['list_noticeby_gov_data']['name']) && is_array($finacial_affairs['list_noticeby_gov_data']['name']))
        ...
        @endfor
    @else
        @include("client.questionnaire.affairs.list_noticeby_gov", ['i' => 0, 'isEmpty'=>true])
    @endif
    <div class="add-more-div-bottom">
        <button type="button" id="add-more-residence-form" class="btn-new-ui-default py-1 px-2" onclick="addListNoticebyGovForm(); return false;">
