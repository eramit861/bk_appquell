                                                    ...
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                ...
                                                                <span
                                                                    style="font-size: 14px;">Hello {{ $name??"User" }},</span>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span
                                                                    style="font-size: 14px;">You have not completed or started your questionnaire as of yet. Lets get the process going, so you can get the stress relief you need.</span><br>
                                                            </p>                                                            
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                &nbsp;</p>
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 14px;">If you prefer not to
                                                                    ...
                                                                    <a href="{{ $unsubscribeUrl ?? 'javascript:void(0)' }}"
