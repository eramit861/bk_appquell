                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                ...
                                                                <span
                                                                    ...
                                                                    has logged into the questionnaire for the first time
                                                                    to start their online
                                                                    questionnaire.{!! '&nbsp;' !!}</span><br><span
                                                                    style="font-size: 14px;">They have your law firm
                                                                    information in case they have any legal
                                                                    questions.{!! '&nbsp;' !!}</span>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                            ...
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span style="font-size: 14px;">They also have our
                                                                    technical support information should they need any
                                                                    technical support. If they reach out to us for any
                                                                    technical support questions, we will let you
                                                                    know.</span>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
