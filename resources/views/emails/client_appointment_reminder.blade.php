                                                ...
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span style="font-size: 14px;">A friendly reminder don't
                                                                    forget about your appointment with your bankruptcy
                                                                    law firm:</span><br>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                            ...
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span style="font-size: 14px;">Bankruptcy Law Firm
                                                                    Appointment:</span><br>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 14px;">Date:
                                                                    {{ $date }}</span><br>
                                                                <span style="font-size: 14px;">Time:
                                                                    {{ $time }}</span><br>
