                                                    ...
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 14px;">Hey ({{ $clientName }})
                                                                    your ({{ $attorneyName }}) asked us to help you get
                                                                    all your documents and questionnaire filled out.
                                                                    Please select an appointment time and day here that
                                                                    works for you: <a style="color: #0000EE;"
                                                                        target="_blank"
                                                                        href="{{ $url }}">{{ $url }}</a>
                                                                </span><br>
                                                            </p>
