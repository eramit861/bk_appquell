                                                    ...
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                ...
                                                                <span
                                                                    style="font-size: 14px;">{!! nl2br($html) !!}</span><br>
                                                            </p>
                                                            @if (isset($data) && !empty($data) && is_array($data))
                                                                @foreach ($data as $index => $dataObj)
                                                                    <p>
                                                                        @if ($dataObj['type'] == 'image')
                                                                            <img src="{{ htmlspecialchars($dataObj['path'], ENT_QUOTES, 'UTF-8') }}"
                                                                                width="auto" style="max-width: 500px;"
                                                                                alt="Image">
                                                                        @else
                                                                            <a href="{{ $dataObj['path'] }}"
                                                            ...
                                                            @if (isset($hideEmail) && $hideEmail !== true)
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
