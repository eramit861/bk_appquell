                                                        ...
                                                        <div
                                                            ...
                                                            @if (!empty($extra_message))
                                                                <p
                                                                    style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                    <span
                                                                        style="font-size: 14px;">{!! $extra_message !!}</span><br>
                                                                </p>
                                                            @endif
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                            ...
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span style="font-size: 14px;">Paralegal
                                                                    Details:</span><br>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                            ...
                                                            <p
                                                                ...
                                                                @if (!empty($appointment_link))
                                                                    <br>
                                                                    <span style="font-size: 14px;">Appointment Link:
                                                                        <a href="{{ $appointment_link }}"
                                                                            style="color: #0000EE; font-size: 14px;"
                                                                            target="_blank">{{ $appointment_link }}</a>
                                                                    </span>
                                                                @endif
                                                            </p>
                                                            <p
