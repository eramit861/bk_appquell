                                                    ...
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 14px;">Hey ({{ $username }})
                                                                    My name is Mike, why not let me help you get all the
                                                                    documents uploaded and questionnaire filled?
                                                                    ({{ $attorney_name }}) asked me to reach out so it's
                                                                    a quicker simpler process for you. All you need to
                                                                    do is set up an appointment with me and let me do a
                                                                    lot of the work for you: <a style="color: #0000EE;"
                                                                        target="_blank"
                                                                        href="{{ $url }}">{{ $url }}</a>
                                                                </span></p>
                                                            <p
