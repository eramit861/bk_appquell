                          ...
                          <td align="left" style="font-size:0px;padding:0px 15px 15px 15px;word-break:break-word;">
                            <div
                              ...
                              <p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                <span style="font-size: 14px;">{!! nl2br(e($html)) !!}</span><br>
                                <?php if(!empty($link)) {?>
                                  <a href="{{ $link }}" style="font-size: 14px; color: #0000EE;">{{$link}}</a>
                                <?php } ?>
                              </p>
                              <p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">&nbsp;</p>
                              <p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                <span style="font-size: 14px;">If you have any technical questions or concerns you may reach us at:</span><br>
                              ...
                              <p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;text-align:center;">
                                ...
                                <span style="font-size: 14px;">Copyright © {{date('Y')}} BK Assistant</span>
                              </p>
                            </div>
                          </td>
                        </tr>
