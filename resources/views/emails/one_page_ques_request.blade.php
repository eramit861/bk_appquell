                                                    ...
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            ...
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span
                                                                    style="font-size: 14px;"><strong>{{ $name }}</strong>,
                                                                    has submitted their online
                                                                    questionnaire request.&nbsp;</span><br>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                <span style="font-size: 14px;">Client Email: <a
                                                                        href="mailto:{{ $email }}"
                                                                        style="color: #0000EE;">{{ $email }}</a></span>
                                                            </p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                &nbsp;</p>
                                                            <p
                                                                ...
                                                                For more details <a target="_blank"
                                                                    style="color: #0000EE;"
                                                                    href="{{ route('login') }}">Login</a> your account
                                                                and check Short Form Questionnaire section.</p>
                                                            <p
                                                                style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial;">
                                                                &nbsp;</p>
                                                            ...
                                                            <p
                                                                ...
                                                                <span style="font-size: 14px;">If you have any
                                                                    &nbsp;technical questions or concerns you may reach
                                                                    us at:</span><br><span
