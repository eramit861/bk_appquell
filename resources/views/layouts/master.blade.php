...
<head>
    ...
    @php
        ...
        $metaTags = $metaService->getMetaForRoute($routeName, $meta ?? []);
    @endphp
    ...
    <meta property="og:title" content="{{ $metaTags['og']['og:title'] }}">
    <meta property="og:description" content="{{ $metaTags['og']['og:description'] }}">
    <meta property="og:image" content="{{ $metaTags['og']['og:image'] }}">
    <meta property="og:url" content="{{ $metaTags['og']['og:url'] }}">
    <meta property="og:type" content="{{ $metaTags['og']['og:type'] }}">
    <meta property="og:site_name" content="{{ $metaTags['og']['og:site_name'] }}">
    <meta property="og:locale" content="{{ $metaTags['og']['og:locale'] }}">
    <meta property="og:image:width" content="{{ $metaTags['og']['og:image:width'] }}">
    <meta property="og:image:height" content="{{ $metaTags['og']['og:image:height'] }}">
    <meta property="og:image:alt" content="{{ $metaTags['og']['og:image:alt'] }}">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="{{ $metaTags['twitter']['twitter:card'] }}">
    <meta name="twitter:site" content="{{ $metaTags['twitter']['twitter:site'] }}">
    <meta name="twitter:creator" content="{{ $metaTags['twitter']['twitter:creator'] }}">
    <meta name="twitter:title" content="{{ $metaTags['twitter']['twitter:title'] }}">
    <meta name="twitter:description" content="{{ $metaTags['twitter']['twitter:description'] }}">
    <meta name="twitter:image" content="{{ $metaTags['twitter']['twitter:image'] }}">
    <meta name="twitter:image:alt" content="{{ $metaTags['twitter']['twitter:image:alt'] }}">
 ...
 <div class="home-header">
                  ...
                  <div class="brand header-brand">
                    ...
                    <div class="navbar-content">
                        <ul class="pcoded-inner-navbar">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo route('register', ['package_id' => 'standard']); ?>" class="nav-link "><span class="pcoded-mtext">SignUp</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('login')}}" class="nav-link "><span class="pcoded-mtext">Law Firm Login</span></a>
                            </li>
                            <li class="nav-item">
					...
					<div class="navbar-buttons2">
                        ...
                        <a href="mailto:website@bkquestionnaire.com" class="email-us" role="button">
    ...
    <footer class="site-footer">
         ...
         <div class="footer-col1">
             ...
             <ul >
							<li >
											<a href="<?php echo route('register', ['package_id' => 'standard']); ?>">
          ...
          <div class="footer-col2">
              ...
              <ul >
							...
							<i aria-hidden="true" class="fas fa-phone-alt"></i>						</span>
								...
								<li>
											<a href="mailto:website@bkquestionnaire.com">

												<span class="icon-list-icon">
							<i aria-hidden="true" class="far fa-envelope"></i>						</span>
										<span class="icon-list-text">website@bkquestionnaire.com</span>
											</a>
									</li>
						</ul>
          </div>
           <div class="footer-col3">
            ...
            <div class="footer-copyright-text">Copyright © <?php echo date('Y'); ?> {{config('app.name') }} All rights reserved.</div>
