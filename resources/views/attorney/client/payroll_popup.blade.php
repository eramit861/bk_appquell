<?php $packageDetailedLabel = \App\Models\AttorneySubscription::addonNameArrayForBuyPopup($package_id); ?>
    ...
    <div class="modal-body">
        <div class="card-body light-gray-div mt-2 mb-1">
            ...
            <div class="row ">
                ...
                <div class="col-12 col-md-12">
                    <?php if ($availableCount >= $noofCountneeded) { ?>
                    ...
                    <?php } else {
                        $url = route('attorney_profile', ['tab' => 4, 'package' => $package_id]); ?>
                        <div class="d-flex">
