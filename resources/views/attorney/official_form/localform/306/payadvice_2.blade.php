<div class="row">
    ...
    <div class="col-md-12 mt-3">
        <p class="p_justify">
            ...
            I*,
            <input type="text" name="<?php echo base64_encode('Text4');?>" value="{{$spousename}}" class="form-control w-auto"> 
            {{ __("(Co-Debtor's name), state that I did not file copies of all payment
            advices or other evidence of payment received within 60 days before the date of the filing of the petition, by me
            from any employer because:") }}
        </p>
    </div>

    <div class="col-md-1 pr-0">
        <p class="">
            <input type="checkbox" name="<?php echo base64_encode('Check Box6');?>" value="Yes" class="spouse_not_payment_received form-control w-auto">
            {{ __('.(1)') }}
        </p>
    </div>
    <div class="col-md-11">
        ...
        {{ __('I was not employed during the period immediately preceding the filing of the above-referenced case') }}
            <input type="text" name="<?php echo base64_encode('Text5');?>" value="" class="form-control w-auto">
    ...
    <div class="col-md-1 pr-0">
        <p class="">
            <input type="checkbox" name="<?php echo base64_encode('Check Box7');?>" value="Yes" class="spouse_payment_received form-control w-auto">
            {{ __('.(2)') }}
        </p>
    </div>
    <div class="col-md-11">
    ...
    <div class="col-md-12">
        <p class="">
            <span class="pl-4"></span>
            <input type="text" name="<?php echo base64_encode('Text14');?>" class="form-control width_30percent" value="{{$debtor2_sign}}">
            {{ __('(Co-Signature of Debtor)') }}
        </p>
    </div>
