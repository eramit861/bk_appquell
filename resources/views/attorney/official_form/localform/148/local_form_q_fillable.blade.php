<div class="row">
    ...
    <div class="col-md-6 border_1px p-3">
        ...
        <div class="row">
            <div class="col-md-12 pt-2">
                ...
                <p class="mt-3">{{ __('CERTIFICATION OF PLAN COMPLETION AND
                    REQUEST FOR DISCHARGE') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12 mt-3">
        ...
        <div class=" d-flex">
            ...
            <div class="row pl-1">
                <div class="col-md-12">
                    <p class="pl-4"> 
                        {{ __('All plan payments have been completed and the debtor is entitled to a discharge.') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row pl-1">
                <div class="col-md-12">
                    ...
                    <div class="row pl-4">
                        ...
                        <div class="col-md-10">
                            <input name="<?php echo base64_encode('Text2');?>" type="text" class="form-control">
                        </div>
                        <div class="col-md-2">
                            <label for="">{{ __('Address:') }}</label>
                        </div>
                        <div class="col-md-10">
                            <input name="<?php echo base64_encode('Text3');?>" type="text" class="form-control">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-10">
                            <input name="<?php echo base64_encode('Text4');?>" type="text" class="form-control">
                        </div>
                        <div class="col-md-2">
                            <label for="">{{ __('Address:') }}</label>
                        </div>
                        <div class="col-md-10">
                            <input name="<?php echo base64_encode('Text5');?>" type="text" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row pl-1">
                <div class="col-md-12">
                    <p class="pl-4"> 
                        ...
                        preceding the date of the order for relief under this Chapter, or in a case filed under Chapter 13 of this title
                        during the 2-year period preceding the date of such Order') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row pl-1">
                <div class="col-md-12">
                    <p class="pl-4"> 
                        ...
                        U.S.C. § 111 and haseither previously filed Official Fo rm 23 so certifying with the Court, or such certification
                        and accompanying documents are being contemporaneously filed herewith.') }}
                    </p>
                </div>
            </div>
        </div>
        <p>{{ __('The undersigned requests that a discharge be granted in accordance with 11 U.S.C. § 1328.') }}</p>
    </div>
    ...
    <div class="col-md-6 mt-2">
        <div class="input-group">
            ...
            <textarea name="<?php echo base64_encode('Text7');?>" class="form-control" rows="3"></textarea>
        </div>
    </div>
    ...
    <div class="col-md-6 mt-2">
        <div class="input-group">
            <label for="">{{ __('Debtor') }}</label>
            <textarea name="<?php echo base64_encode('Text8');?>" class="form-control" rows="3"></textarea>
        </div>
    </div>
