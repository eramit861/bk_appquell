<div class="row">
    ...
    <div class="col-md-12 mt-3">
        <h3 class="text-center underline">{{ __('AMENDED SCHEDULE') }}</h3>
    </div>
    <div class="col-md-12 mt-3">
        <p><label class="pl-4">&nbsp;</label>
            {{ __('NOW COME THE DEBTOR(S) and hereby moves to amend the following schedule as
            submitted to the court. The amended schedule is attached hereto.') }}
        </p>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-12 mb-3 ">
        ...
        <p class="mt-1">{{ __('on the') }} 
            <input type="text" class="form-control width_auto ml-2" name="<?php echo base64_encode('day'); ?>">
            {{ __('day of') }} 
