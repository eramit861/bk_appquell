<div class="row">
    ...
    <div class="col-md-12 mt-3">
        <p><span class="text-bold pr-2">{{ __('To:') }}</span><span class="text-bold">{{ __('Affected Party') }}</span>
            <span class="text_italic text-c-red pr-1">[{{ __('List name & address of each affected creditor') }}
            <span class="underline"> or </span> {{ __('attach a list containing the name & address of each affected creditor') }}</span>
        </p>
    ...
    <div class="col-md-12 mt-3 mb-2">
        ...
        <p class="">
            ...
            {{ __('that the debtor(s) named above has filed with the Bankruptcy Court an Amendment of Schedules adding one or more additional creditors. (See amended schedules enclosed.') }} )
        </p> 
        <p class="">
    ...
    <div class="col-md-12 mt-3 mb-2">
        ...
        <p class="">
            <span class="pl-4"></span> 
            {{ __("I, the undersigned attorney for the above-referenced debtor(s), do hereby certify that I have this date served a true and correct copy of the notice of amendment, § 341 Meeting of Creditors Notice, and the amended schedules to the affected creditor(s) via First Class U.S. Mail and the case trustee and U.S. Trustee via Notice of Electronic Filing (NEF) through the ECF system.") }}
        </p> 
    </div>
    <div class="col-md-6 mt-3 pl-5">
        <x-officialForm.dateSingleHorizontal
    ...
    <div class="col-md-6 mt-3">
        <textarea name="<?php echo base64_encode('Text25')?>" value="" class="form-control" rows="5" cols="">{{$attorney_name}}, {{$attorney_state_bar_no}}
