<div class="row">
    ...
    <div class="col-md-12 mb-3 text-center">
        ...
        {{ __("Notice of Amendment Schedule H: Your Codebtors") }}</h3>
    ...
    <div class="col-md-12 mt-3 mb-2">
        <h3 class="text-center underline mb-3">{{ __("Notice of Amendment of Schedule H") }}</h3>
        <p class="">
            <span class="text-bold pl-4"> {{ __("You are hereby notified") }} </span> {{ __("above named debtor(s) has filed with the U.S. Bankruptcy Court an") }} 
                <span  class="text_italic"> {{ __("Amended Schedule H: Your Codebtors") }}</span>
        ...
        <p class="">
            ...
            {{ __("(date). Documents filed in the case may be inspected at either location of the Clerk’s office:") }}
        </p> 
    </div>
    ...
    <div class="col-md-6 mt-3">
     ...
     <div class="col-md-12 mt-3"> 
        ...
        <p> <span class="pl-4"></span>
            ...
            <span class="text_italic"> {{ __("Notice of Amendment and Amended Schedule H: Your Codebtors") }} </span>
             {{ __("affected party via First Class U.S. Mail and the case trustee and U.S. Trustee via Notice of Electronic Filing (NEF) through the ECF system.") }}
        </p> 
     </div> 
     <div class="col-md-6">
    ...
    <div class="col-md-6 mt-3">
        <textarea name="<?php echo base64_encode('Text28')?>" value="" class="form-control" rows="5" cols="">{{$attorney_name}}, {{$attorney_state_bar_no}}
