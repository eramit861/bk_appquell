<div class="row">
    ...
    <div class="col-md-12 mb-3 text-center pr-0 pl-0">
        <h3 class="mb-3 text-c-red  border_bottom_1px pb-2">{{ __("Example") }} <br>{{ __("Ch. 7 - Asset - Notice of Amendment (Amend Schedules & List of Creditors)") }}</h3>
    ...
    <div class="col-md-12 mt-3 mb-2">
        ...
        <p class="">
            ...
            {{ __("Please take notice") }} </span>
            {{ __("the debtor(s) named above filed with the Bankruptcy Court an Amendment of Schedules to add one or more additional creditors. (See amended schedules enclosed.)") }}
        </p> 
        <p class="">
            ...
            {{ __("from the date of this notice.") }} ({{ __("See copy of the original") }} 
        ...
        <p><span class="pl-4"></span>
            ...
            <a href="#"><span class="underline text-c-blue">www.uscourts.gov </span></a> 
            {{ __("any bankruptcy clerk’s office.") }}
        </p>
    ...
    <div class="col-md-6 mt-3">
        <textarea name="<?php echo base64_encode('Text22')?>" value="" class="form-control" rows="5" cols="">{{$attorney_name}}, {{$attorney_state_bar_no}}
