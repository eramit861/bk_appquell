<div class="row">
    ...
    <div class="col-md-6 border_1px p-3 br-0 ">
        <div class="input-group ">
            ...
            <textarea name="" class=" form-control" rows="2" style="padding-right:5px;">{{$debtorname}}</textarea>
        </div> 
    ...
    <div class="col-md-6 border_1px p-3 ">
        ...
        <div class="d-flex mt-3">
            <div class="">
                <input type="checkbox" value="" name="" class=" form-control w-auto height_fit_content">
            </div>
            <div class="w-100">
                <label for=""> {{ __('Check if this form is submitted with an amended creditor list') }}</label>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12 mt-3">
        <p class=" p_justify">{{ __('I(I/We) declare under penalty of perjury that all entities included or to be included in Schedules D, E/F, G, and H are listed in the creditor list submitted with this verification. This includes all creditors, parties to leases and executory contracts, and codebtors.') }}</p>
