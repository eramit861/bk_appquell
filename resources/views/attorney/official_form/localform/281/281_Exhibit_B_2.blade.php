...
<div class="row my-4">
    ...
    <p><span class="pl-5"></span>{{ __('As an individual debtor in this case, or as the individual authorized to act on behalf of the
          ...
          petition, lists, statements, and schedules to be filed electronically in this case and') }} <span class="text_italic text-bold">{{ __('I hereby
          declare under penalty of perjury') }}</span>{{ __('that the information provided therein, as well as the social security
          information
          ...
          been filed electronically. I understand that a failure to file the signed original of this Declaration will
          result in the dismissal of my case.') }}</p>
    <div class="d-flex mt-3">
        <input type="checkbox" class="form-control w-auto height_fit_content mr-4" name="<?php echo base64_encode('Check Box3'); ?>" value="Yes">
        <div>
            <label><span class="text_italic">{{ __('[Only include for Chapter 7 individual petitioners whose debts are primarily consumer debts] –') }}</span><br>
    ...
    <div class="d-flex mt-3">
        <input type="checkbox" class="form-control w-auto height_fit_content mr-4" name="<?php echo base64_encode('Check Box4'); ?>" value="Yes">
        <div>
          ...
          and lists of creditors on behalf of the debtor in this case.') }}</label>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <input name="<?php echo base64_encode('Text3'); ?>" type="text" value="{{$debtor_sign}}" class="form-control">
        </div>
        <div class="col-md-4">
            <input name="<?php echo base64_encode('Text4'); ?>" type="text" value="{{$debtor2_sign}}" class="form-control">
        </div>
    </div>
