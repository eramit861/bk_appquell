<div class="row">
    ...
    <div class="col-md-12 text-center mt-3">
        ...
        <p class="mt-2">***IN JOINT FILINGS, A SEPARATE STATEMENT MUST BE COMPLETED BY EACH DEBTOR***</p>
    </div>

    <div class="col-md-12 p_justify">
        <p>
            I, 
            <input type="text" name="<?php echo base64_encode("I"); ?>" value="{{$onlyDebtor}}" class="form-control width_50percent">
            {{ __('(debtor’s name), state that I did not
        ...
        <p class="pl-4">
            <input type="checkbox" name="<?php echo base64_encode("1 I was not employed during the period immediately preceding the filing of the"); ?>" Value="On" class="form-control w-auto not_payment_received">
        ...
        <p class="pl-4">
            <input type="checkbox" name="<?php echo base64_encode("2 I was employed during the period immediately preceding the filing of the above"); ?>" Value="On" class="form-control w-auto payment_received">
