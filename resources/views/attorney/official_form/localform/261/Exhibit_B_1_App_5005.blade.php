<div class="row">
    ...
    <div class="col-md-12 mb-3 mt-3">
        ...
        {{ __('DECLARATION FOR ELECTRONIC FILING OF BANKRUPTCY') }}<br>
            <span class="underline">{{ __('PETITION, LISTS, STATEMENTS, AND SCHEDULES') }}</span>
        </h3>
    </div>
    ...
    <div class="col-md-12 mb-3">
        ...
        <p>
            ...
            petition, lists, statements, and schedules to be filed electronically in this case and') }} <span class="text-bold text_italic">{{ __('I hereby declare under
    ...
    <div class="col-md-4">
        <input type="text"  name="<?php echo base64_encode('Text4'); ?>" value="{{$debtor_sign ?? ''}}" class="form-control bg-none" disabled>
    ...
    <div class="col-md-4">
        <input type="text"  name="<?php echo base64_encode('Text5'); ?>" value="{{$debtor2_sign ?? ''}}" class="form-control bg-none" disabled>
