<div class="row">
    ...
    <div class="88_d1 col-md-12 padd-20">
        <div class="row">
            <div class="88_d1 col-md-12">
    ...
    <div class="88_d1 col-md-12">
        <div class="row align-items-center">
            ...
            <div class="88_d1 col-md-12">
                <p>
                    I, <input type="text" name="<?php echo base64_encode('Text3');?>" class="form-control width_30percent" value="{{$onlyDebtor}}"> <span class="text-bold">[name]<sup>1</sup></span> {{ __('state as follows:') }}
                </p>
                <p>
                ...
                <div class="d-flex">
                    <div class="">
                        <input type="checkbox" value="Yes" name="<?php echo base64_encode('Check Box3');?>" class="form-control w-auto not_payment_received">
                    </div>
                    <div class="w-100">
                        <p>{{ __('I was not employed during the period immediately preceding the filing of the above-referenced case:') }}</p>
                        <input type="text" name="<?php echo base64_encode('Text4');?>" name="<?php echo base64_encode('');?>" class="form-control">
                        <p class="text-bold">{{ __('[insert the dates you were not employed].') }}</p>
                    </div>
                </div>
                <div class="d-flex">
                    <div class="">
                        <input type="checkbox" value="Yes" name="<?php echo base64_encode('Check Box4');?>" class="form-control w-auto payment_received">
                    </div>
                    <div class="">
                        <p>
                ...
                <div class="d-flex">
                    <div class="">
                        <input type="checkbox" value="Yes" name="<?php echo base64_encode('Check Box6');?>" class="form-control w-auto mt-2">
                    </div>
                    <div class=" w-100">
                        <p class="mb-0">
                        {{ __('Other') }}: <input type="text" name="<?php echo base64_encode('Text5');?>" class="form-control width_90percent">
                        </p>
            ...
            <div class="88_d1 col-md-1">
                <label for="">By:</label>
            </div>
            <div class="88_d1 col-md-5">
            ...
            <div class="88_d1 col-md-6 mt-1"></div>
            <div class="88_d1 col-md-2 mt-1">
                <label for="">{{ __('Mailing Address:') }}</label>
            </div>
            <div class="88_d1 col-md-4 mt-1">
                <input type="text" name="<?php echo base64_encode('Text7');?>" class="form-control" value="{{$debtoraddress}}, {{$debtorCity}} {{$debtorState}}, {{$debtorzip}}">
            </div>
            ...
            <div class="88_d1 col-md-4 mt-1">
                <input type="text" name="<?php echo base64_encode('Text8');?>" class="form-control" value="{{$debtorPhoneHome}}">
            </div>
            ...
            <div class="88_d1 col-md-4 mt-1">
                <input type="text" name="<?php echo base64_encode('Text9');?>" class="form-control">
            </div>
            ...
            <div class="88_d1 col-md-4 mt-1">
                <input type="text" name="<?php echo base64_encode('Text10');?>" class="form-control" value="{{$debtor_email}}">
            </div>

            <div class="88_d1 col-md-6 mt-1">
                <textarea name="<?php echo base64_encode('');?>" class="form-control bg-none" disabled rows="4"></textarea>
            </div>
            <div class="88_d1 col-md-6 mt-1"></div>

            <div class="88_d1 col-md-12 mt-1">
