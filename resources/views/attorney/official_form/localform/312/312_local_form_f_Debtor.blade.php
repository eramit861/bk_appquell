<div class="row">
    ...
    <div class="col-md-12 mt-3">
        <p>
            I*, 
            <input type="text" name="<?php echo base64_encode('Text40');?>" class=" form-control width_30percent" value="{{$onlyDebtor}}">    
        ...
        <div class="d-flex">
            <div class="pl-3 pt-2">
                <input type="checkbox" value="Yes" name="<?php echo base64_encode('Check Box41');?>" class=" form-control w-auto height_fit_content not_payment_received">    
            </div>
        ...
        <div class="d-flex">
            <div class="pl-3">
                <input type="checkbox" value="Yes" name="<?php echo base64_encode('Check Box42');?>" class=" form-control w-auto height_fit_content payment_received">    
            </div>
            <div class="pl-4 w-auto">
                <p>
