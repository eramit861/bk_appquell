<div class="row">
    ...
    <div class="col-md-12 mt-3 mb-3">
        ...
        <p>
            <span class="pl-4"></span>
            I, 
            <input type="text" name="<?php echo base64_encode('hereby'); ?>" class="form-control mt-1 width_30percent" value="{{$onlyDebtor}}">
            {{ __('hereby state as follows') }}:<br>{{ __("(debtor's name)") }}
        </p>
        <p class=" text_italic">
            {{ __('(select one)') }}
        </p>
        <div class="d-flex">
            ...
            <div class="w-100 pl-4">
                <p class="mb-2 ">{{ __('I have attached hereto, or previously filed w ith the C ourt, copies of all paym ent advices or other
        ...
        <div class="d-flex">
            ...
            <div class="w-100 pl-4">
                <p class="mb-2 ">{{ __('I did not receive any payment advices or other evidence of payment from any employer at any point
                    ...
                    <input type="text" name="<?php echo base64_encode('tx1');?>" class="form-control width_30percent">
                </p>
            </div>
        </div>
        <p class="text_italic">
