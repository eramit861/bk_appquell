<div class="row">
    ...
    {{ __('Statement Under Penalty of Perjury Concerning Payment Advices') }}<br>
        ...
        <div class="d-flex">
            <input type="checkbox" class=" spouse_not_payment_received form-control height_fit_content w-auto" name="<?php echo base64_encode('Check Box5.0'); ?>" value="Yes">
                <div class="row w-100">
        ...
        <div class="d-flex">
            <input type="checkbox" class="spouse_payment_received form-control height_fit_content w-auto" name="<?php echo base64_encode('Check Box5.1'); ?>" value="Yes">
            <div class="w-100">
               <p>  
