@php
    // Initialize and validate current employer data
    $currentEmployerData = Helper::validate_key_value('currentEmployer', $income_info);
    ...
    <div class="light-gray-div">
        <div class="light-gray-box-form-area">
            <h2 class="  align-items-center ">
                <span class="">{{ $debtorname }} Employer Information </span>                    
            </h2>
            <div class="row gx-3 set-mobile-col">
                ...
                {{-- Current Employer Information Section --}}
                @if($isEmployed)
                    @include("client.questionnaire.income.ajax_summary.employer_summary_only_att_side",[ 'currentEmployerData' => $currentEmployerData ])
                @endif
                
                {{-- Previous Employer Information Section --}}
                @php
                    $previousEmployerData = Helper::validate_key_value('previousEmployer', $income_info);
